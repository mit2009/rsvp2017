...
export const levelMap: ILevelMap = {
    ...
    //tslint:disable-next-line:prettier
    4: [4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 19, 19, 19, 19, 19, 19, 19, 19, 1, 1, 1, 4, 13, 13, 13, 4, 2, 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 1, 2, 2, 2, 2, 2, 2, 2, 19, 19, 19, 1, 4, 13, 5, 13, 4, 8, 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 19, 1, 4, 13, 13, 13, 4, 2, 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 19, 19, 4, 2, 2, 2, 4, 4, 1, 1, 2, 6, 2, 1, 1, 2, 2, 2, 2, 1, 1, 2, 6, 2, 1, 1, 2, 6, 2, 2, 2, 19, 4, 2, 2, 2, 2, 2, 1, 1, 2, 2, 2, 1, 1, 2, 11, 2, 2, 1, 1, 2, 2, 2, 1, 1, 2, 2, 2, 2, 2, 19, 4, 2, 2, 2, 2, 2, 1, 1, 2, 2, 2, 1, 1, 2, 2, 11, 2, 1, 1, 2, 2, 2, 1, 1, 2, 2, 2, 2, 2, 19, 4, 2, 2, 2, 6, 2, 1, 1, 2, 6, 2, 1, 1, 2, 2, 2, 2, 1, 1, 2, 6, 2, 1, 1, 19, 19, 2, 2, 2, 19, 4, 4, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 1, 2, 19, 13, 13, 13, 19, 1, 4, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 1, 10, 19, 13, 5, 13, 19, 1, 4, 4, 4, 2, 2, 2, 2, 2, 2, 2, 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 1, 2, 19, 13, 13, 13, 19, 1, 1, 1, 4, 4, 4, 4, 4, 4, 4, 4, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19],
    //tslint:disable-next-line:prettier
